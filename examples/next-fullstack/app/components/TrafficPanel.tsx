...
export function TrafficPanel() {
  return (
    <section aria-labelledby="traffic-heading" className="demo-section">
      ...
      <details className="demo-secondary-traffic" data-testid="secondary-traffic">
        <summary>
          <span className="demo-secondary-traffic-title">Push it further</span>
          <span className="demo-secondary-traffic-copy">
            13 optional generators for errors, protocols, and inspector tools
          </span>
        </summary>
        <div className="demo-grid">
          <DemoCard
