...
`0.1.1` (not a range) — a stricter pin than most peer dependencies in this ecosystem, worth
...
This plugin is v0.1.1 and read-only: unlike Rozenite's own official
