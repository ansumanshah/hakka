...
<CardGrid>
  <LinkCard
    title="Plain-web demo"
    href="https://github.com/ansumanshah/hakka/tree/main/examples/browser-demo"
    description="Run the script-tag demo and generate real fetch, XHR, beacon, WebSocket, and rule traffic."
  />
  <LinkCard
    title="Vite plugin"
    href="/web/vite/"
  ...
  <LinkCard
    ...
    href="/guides/build-your-own-devtools/"
    description="Compose the standalone elements or React wrappers into your own network UI."
  />
  <LinkCard
    title="Breakpoints"
