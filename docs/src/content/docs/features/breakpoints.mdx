---
title: Breakpoints
description: Pause matching requests or responses in-flight, edit them, then resume in-process with no proxy or certificate.
sidebar:
  badge:
    text: New
    variant: tip
...
<Aside type="tip" title="What this does">
  Pause a request or response in-flight, edit it, then resume in-process with no proxy or certificate.
</Aside>
